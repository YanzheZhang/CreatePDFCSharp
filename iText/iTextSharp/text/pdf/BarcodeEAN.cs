...
namespace iTextSharp.text.pdf {
    ...
    internal static int[] GUARD_EMPTY = {};
    /** The bar positions that are guard bars.*/    
    internal static int[] GUARD_UPCA = {0, 2, 4, 6, 28, 30, 52, 54, 56, 58};
    /** The bar positions that are guard bars.*/    
    internal static int[] GUARD_EAN13 = {0, 2, 28, 30, 56, 58};
    /** The bar positions that are guard bars.*/    
    internal static int[] GUARD_EAN8 = {0, 2, 20, 22, 40, 42};
    /** The bar positions that are guard bars.*/    
    internal static int[] GUARD_UPCE = {0, 2, 28, 30, 32};
    /** The x coordinates to place the text.*/
    internal static float[] TEXTPOS_EAN13 = {6.5f, 13.5f, 20.5f, 27.5f, 34.5f, 41.5f, 53.5f, 60.5f, 67.5f, 74.5f, 81.5f, 88.5f};
    /** The x coordinates to place the text.*/
    internal static float[] TEXTPOS_EAN8 = {6.5f, 13.5f, 20.5f, 27.5f, 39.5f, 46.5f, 53.5f, 60.5f};
    ...
    internal static int TOTALBARS_EAN13 = 11 + 12 * 4;
    /** The total number of bars for EAN8.*/
    internal static int TOTALBARS_EAN8 = 11 + 8 * 4;
    /** The total number of bars for UPCE.*/
    internal static int TOTALBARS_UPCE = 9 + 6 * 4;
    /** The total number of bars for supplemental 2.*/
    internal static int TOTALBARS_SUPP2 = 13;
    /** The total number of bars for supplemental 5.*/
    internal static int TOTALBARS_SUPP5 = 31;
    /** Marker for odd parity.*/
    internal static byte ODD = 0;
    /** Marker for even parity.*/
    internal static byte EVEN = 1;
