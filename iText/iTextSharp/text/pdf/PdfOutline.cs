...
/*
 * $Id: PdfOutline.cs,v 1.1.1.1 2003/02/04 02:57:34 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
	...
	public class PdfOutline : PdfDictionary {
		 ...
		 * @param open <CODE>true</CODE> if the children are visible
		 */
		public PdfOutline(PdfOutline parent, PdfAction action, PdfString title, bool open) : this(parent, action, title.ToString(), true) {}
