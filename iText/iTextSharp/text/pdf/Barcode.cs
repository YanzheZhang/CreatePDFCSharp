...
namespace iTextSharp.text.pdf {
	...
	public abstract class Barcode {
		...
		/** A type of barcode */
		public const int CODE128_RAW = 10;
		 ...
		 */
		public bool isGenerateChecksum() {
		 ...
		 */    
		public abstract Rectangle placeBarcode(PdfContentByte cb, object barColor, object textColor);
