...
/*
 * $Id: PdfBoolean.cs,v 1.1.1.1 2003/02/04 02:57:03 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
	...
	internal class PdfBoolean : PdfObject {
		...
		public static PdfBoolean PDFTRUE = new PdfBoolean(true);
		public static PdfBoolean PDFFALSE = new PdfBoolean(false);
