...
/*
 * $Id: PdfIndirectReference.cs,v 1.1.1.1 2003/02/04 02:57:29 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
	...
	public class PdfIndirectReference : PdfObject {
		...
		internal PdfIndirectReference(int type, int number, int generation) : base(type, new StringBuilder().Append(number).Append(" ").Append(generation).Append(" R").ToString()) {
			this.number = number;
