...
/*
 * $Id: PdfString.cs,v 1.1.1.1 2003/02/04 02:57:44 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
	...
	public class PdfString : PdfObject {
		...
		internal byte[] get(PdfWriter writer) {
			return toPdf(writer);
			// we create the StringBuilder that will be the PDF representation of the content
		}
