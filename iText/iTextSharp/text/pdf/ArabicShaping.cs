...
namespace iTextSharp.text.pdf {
	...
	public sealed class ArabicShaping {
		...
		///   It may be NULL only if  destSize is 0.  
		/// </param>
		...
		//private static int DIGITS_RESERVED = 0xa0;
		...
		public override string ToString() {
			...
			switch (options & LENGTH_MASK) {
				case ArabicShaping.LENGTH_GROW_SHRINK: buf.Append("grow/shrink"); break;
		...
		private static int IRRELEVANT = 4;
		private static int LAMTYPE = 16;
		private static int ALEFTYPE = 32;

		private static int LINKR = 1;
		private static int LINKL = 2;
		private static int LINK_MASK = 3;

		private static int[] irrelevantPos = { 
												 0x0, 0x2, 0x4, 0x6, 0x8, 0xA, 0xC, 0xE 
											 };

		private static char[] convertLamAlef =  {
													'\u0622', // FEF5 
													'\u0622', // FEF6
													'\u0623', // FEF7
													'\u0623', // FEF8
		...
		private static char[] convertNormalizedLamAlef = {
															 '\u0622', // 065C
															 '\u0623', // 065D
															 '\u0625', // 065E
															 '\u0627', // 065F
		...
		private static int[][][] shapeTable = {
												  new int[][] { new int[] {0,0,0,0}, new int[] {0,0,0,0}, new int[] {0,1,0,3}, new int[] {0,1,0,1} },
												  new int[][] { new int[] {0,0,2,2}, new int[] {0,0,1,2}, new int[] {0,1,1,2}, new int[] {0,1,1,3} },
												  new int[][] { new int[] {0,0,0,0}, new int[] {0,0,0,0}, new int[] {0,1,0,3}, new int[] {0,1,0,3} },
												  new int[][] { new int[] {0,0,1,2}, new int[] {0,0,1,2}, new int[] {0,1,1,2}, new int[] {0,1,1,3} }
											  };
		...
		*/
		 ...
		 *           Isolated, Initial, Middle and Form
		 */
		...
		private int internalShape(char[] source, 
			...
			System.Array.Copy(source, sourceStart, temp, 0, sourceLength);
			...
			System.Array.Copy(temp, 0, dest, destStart, outputSize);
