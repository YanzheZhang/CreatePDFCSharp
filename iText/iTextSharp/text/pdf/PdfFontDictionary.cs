...
/*
 * $Id: PdfFontDictionary.cs,v 1.1.1.1 2003/02/04 02:57:23 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
	...
	public class PdfFontDictionary : PdfDictionary, IPdfResource {
		...
		*/
		...
		internal PdfFontDictionary() : base() {}
		...
		internal bool contains(PdfFont font) {
			return hashMap.ContainsKey(font.Name);
		}
