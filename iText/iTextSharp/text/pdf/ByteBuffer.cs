...
/*
 * $Id: ByteBuffer.cs,v 1.1.1.1 2003/02/04 02:56:43 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
	...
	public class ByteBuffer {
		...
		private static byte[] bytes = new byte[] {(byte)'0', (byte)'1', (byte)'2', (byte)'3', (byte)'4', (byte)'5', (byte)'6', (byte)'7', (byte)'8', (byte)'9'};
...
//		}
		...
		public void WriteTo(Stream str) {
			...
			Array.Copy(buf, 0, test, 0, count);
			str.Write(test, 0, count);
		}
