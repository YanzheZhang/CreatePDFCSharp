...
/*
 * $Id: PdfXObjectDictionary.cs,v 1.1.1.1 2003/02/04 02:57:52 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
	...
	public class PdfXObjectDictionary : PdfDictionary, IPdfResource {
		...
		*/
		...
		internal PdfXObjectDictionary() : base() {}
		...
		internal bool contains(PdfImage image) {
