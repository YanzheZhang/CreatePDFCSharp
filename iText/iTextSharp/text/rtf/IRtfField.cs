...
/**
 * $Id: IRtfField.cs,v 1.3 2003/03/22 21:51:36 geraldhenson Exp $
 *
 * Copyright 2002 by 
...
namespace iTextSharp.text.rtf {
	...
	/// </summary>
	public interface IRtfField {
		/// <summary>
		/// write method
		/// </summary>
		/// <param name="writer">an RtfWriter</param>
		/// <param name="str">a Stream</param>
		void Write( RtfWriter writer, Stream str );
	}
}