...
/*
 * $Id: XmlParser.cs,v 1.2 2003/03/23 22:27:45 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.xml {
	...
	public class XmlParser {
		...
		public void go(IDocListener document, String file) {
		...
		public void go(IDocListener document, String file, String tagmap) {
		...
		/// <param name="file"></param>
		/// <param name="tagmap"></param>
		public void go(IDocListener document, String file, Hashmap tagmap) {
		...
		/// <param name="file"></param>
		/// <param name="tagmap"></param>
		public static void Parse(IDocListener document, String file, Hashmap tagmap) {
			XmlParser p = new XmlParser();
			p.go(document, file, tagmap);
		}
