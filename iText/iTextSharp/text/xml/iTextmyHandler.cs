...
/*
 * $Id: iTextmyHandler.cs,v 1.4 2003/03/25 01:17:17 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.xml {
	...
	public class iTextmyHandler : iTextHandler {
		...
		/// <summary> This Hashmap contains all the custom keys and peers. </summary>
		...
		public iTextmyHandler(IDocListener document, Hashmap myTags) : base(document) {
			this.myTags = myTags;
		}
