...
/*
 * $Id: Anchor.cs,v 1.2 2003/03/09 23:05:09 geraldhenson Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text {
	...
	public class Anchor : Phrase, ITextElementArray, IMarkupAttributes {
		...
		public Anchor(Properties attributes) : this("", FontFactory.getFont(attributes)) {
			string value;
